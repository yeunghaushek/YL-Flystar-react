    ...
    useEffect(() => {
      ...
      const myStarPalaceMap = palaces
        ...
        const buildEntry = (starName) => ({
          name: p.name,
          star: starName,
          innerGreen: greenMap.get(starName) || [],
          innerRed: redMap.get(starName) || [],
          outerBlue,
        });
        ...
        <>
          ...
          <Link href="/info#contact">
            ...
            <div className="container">
                    ...
                    <TextField label="出生日期" name="birthday" value={`${year}-${month}-${day}`} onChange={() => {}} />
                            ...
                            <Grid item xs={12}>
                                <FormControl fullWidth>
                                    ...
                                    <Select labelId="birthTime-label" id="birthTime" name="birthTime" value={birthTime} label="時辰" onChange={handleBirthTime}>
                                                ...
                                                {palaceItem.minorStars.map((star, sIndex) => {
                                                    return (
                                                        <div className={palaceStyle.minor} key={`key-minorStars-${sIndex}`}>
                                                                    ...
                                                                    {pluginUnderline && currentArrows.length > 0
                                                                        ? currentArrows.map((arrow) => {
                                                                              if (arrow[1] == starList.findIndex((s) => s === star.name))
                                                                                  return (
                                                                                      <div
                                                                                          className={`${palaceStyle.line} ${
                                                                                              palaceStyle[getMutagenStyle(arrow[2])]
                                                                                          }`}
                                                                                      ></div>
                                                                                  );
                                                                              return null;
                                                            ...
                                                            {star.mutagen ? (
                                                                <div
                                                                    className={`${palaceStyle.mutagen} ${
                                                                        palaceStyle[getMutagenStyle(mutagenToIndex[star.mutagen])]
                                                                    }`}
                                                                >
                                                                    {star.mutagen}
                                                                </div>
                                            ...
                                            <div className={palaceStyle.middle}>
                                                {showSmallMonth ? (
                                                    <div className={palaceStyle.smallMonth}>
                                                        {`流月${astrolabe.palaces[(lifePalaceIndex - currentMonthIndex + palaceIndex + 12) % 12].name.slice(
                                                            0,
                                                            2
                                                        )}`}
                                                    </div>
                                                ...
                                                {showSmallLuck ? (
                                                    <div className={palaceStyle.smallLuck}>
                                                        {`流年${astrolabe.palaces[(lifePalaceIndex - currentAgeIndex + palaceIndex + 12) % 12].name.slice(
                                                            0,
                                                            2
                                                        )}`}
                                                    </div>
                                                ...
                                                {showChildLuck ? (
                                                    ...
                                                    <div className={`${palaceStyle.bigLuck} ${showBorrow ? `${palaceStyle.smallerByBorrow}` : ``}`}>
                                                        {`大運${astrolabe.palaces[(lifePalaceIndex - currentDecadalIndex + palaceIndex + 12) % 12].name.slice(
                                                            0,
                                                            2
                                                        )}`}
                                                    </div>
                                            ...
                                            palaceIndex === 0 ? (
                                                <div className={`${palaceStyle.arrow} ${palaceStyle.leftBottom} ${palaceStyle.outside}`}>
                                                    {palaceItem.outsideMutagenIndexes.map((item, index) => {
                                                        return (
                                                            <div
                                                                className={`${palaceStyle[getMutagenStyle(item)]}`}
                                                                key={`key-outside-${index}`}
                                                            >{`${Object.keys(mutagenToIndex).find((key) => mutagenToIndex[key] === item)}↙`}</div>
                                                        );
                                                    })}
                                                </div>
                                            ) : palaceIndex === 1 ? (
                ...
                <br />
                <Select value={currentFavIndex} onChange={selectFav} autoWidth sx={{ backgroundColor: "#fff", fontSize: "12px", padding: "0", height: "32px" }}>
